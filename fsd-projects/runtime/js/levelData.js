...
{ type: "sawblade", x: 400, y: groundY - 125, damage : 10},
          ...
          { type: "sawblade", x: 1000, y: groundY - 15, damage : 10},
          { type: "sawblade", x: 1750, y: groundY - 125, damage : 10},
          ...
          {type: "sawblade", x: 3520, y: groundY - 15, damage : 10},
          {type: "sawblade", x: 3820, y: groundY - 125, damage : 10},
          ...
          { type: "enemy", x: 3000, y: groundY - 25, speed: -1, image: "img/SadSal.png", offsetX: -35, offsetY: -25, scale: 0.5},
      ...
      },
      {
        ...
        gameItems: [
          ...
          { type: "enemy", x: 3200, y: groundY - 125, speed: -2, image: "img/SadSal.png", offsetX: -35, offsetY: -25, scale: 0.5},
          ...
          { type: "marker", x: 4000, y: groundY - 30, speed: -5},
        ],
      },
      {
        name: "Robot Romp",
        ...
        { type: "marker", x: 3500, y: groundY - 30, speed: -3},
        ],
      },

      {
        ...
        { type: "sawblade", x: 4500, y: groundY - 15, damage : 5},
        { type: "sawblade", x: 5500, y: groundY - 125, damage : 15},
        { type: "sawblade", x: 6500, y: groundY - 125, damage : 1},
        { type: "reward", x: 100, y: groundY - 165, speed : -1},
        { type: "reward", x: 200, y: groundY - 165, speed : -2},
        { type: "reward", x: 400, y: groundY - 165, speed : -1},
        { type: "reward", x: 700, y: groundY - 165, speed : -5},
        { type: "reward", x: 900, y: groundY - 165, speed : -1},
        { type: "reward", x: 1200, y: groundY - 165, speed : -2},
        ...
        { type: "marker", x: 5300, y: groundY - 30, speed: -3},
